export const site = {
  ...
  socials: [
    { label: "LinkedIn", href: "https://www.linkedin.com/rimiscky/" },
...
export const photos: Photo[] = [
  { src: "/photos/photo-01.jpg", width: 1800, height: 1440, alt: "Photographie par Rimiscky Sambala — série 01" },
  { src: "/photos/photo-05.jpg", width: 1200, height: 1800, alt: "Photographie par Rimiscky Sambala — série 02" },
  { src: "/photos/photo-02.jpg", width: 1800, height: 1200, alt: "Photographie par Rimiscky Sambala — série 03" },
  { src: "/photos/photo-08.jpg", width: 1358, height: 1800, alt: "Photographie par Rimiscky Sambala — série 04" },
  { src: "/photos/photo-03.jpg", width: 1800, height: 1200, alt: "Photographie par Rimiscky Sambala — série 05" },
  { src: "/photos/photo-12.jpg", width: 1200, height: 1800, alt: "Photographie par Rimiscky Sambala — série 06" },
  { src: "/photos/photo-04.jpg", width: 1800, height: 1200, alt: "Photographie par Rimiscky Sambala — série 07" },
  { src: "/photos/photo-06.jpg", width: 1200, height: 1800, alt: "Photographie par Rimiscky Sambala — série 08" },
  { src: "/photos/photo-07.jpg", width: 1800, height: 1306, alt: "Photographie par Rimiscky Sambala — série 09" },
  { src: "/photos/photo-15.jpg", width: 1200, height: 1800, alt: "Photographie par Rimiscky Sambala — série 10" },
  { src: "/photos/photo-09.jpg", width: 1800, height: 1412, alt: "Photographie par Rimiscky Sambala — série 11" },
  { src: "/photos/photo-16.jpg", width: 1192, height: 1800, alt: "Photographie par Rimiscky Sambala — série 12" },
  { src: "/photos/photo-10.jpg", width: 1800, height: 1200, alt: "Photographie par Rimiscky Sambala — série 13" },
  { src: "/photos/photo-17.jpg", width: 1200, height: 1800, alt: "Photographie par Rimiscky Sambala — série 14" },
  { src: "/photos/photo-11.jpg", width: 1800, height: 1445, alt: "Photographie par Rimiscky Sambala — série 15" },
  { src: "/photos/photo-18.jpg", width: 1800, height: 1800, alt: "Photographie par Rimiscky Sambala — série 16" },
  { src: "/photos/photo-13.jpg", width: 1800, height: 1200, alt: "Photographie par Rimiscky Sambala — série 17" },
  { src: "/photos/photo-14.jpg", width: 1800, height: 1200, alt: "Photographie par Rimiscky Sambala — série 18" },
  { src: "/photos/photo-21.jpg", width: 1800, height: 1200, alt: "Photographie par Rimiscky Sambala — Annecy" },
  { src: "/photos/photo-20.jpg", width: 1404, height: 1800, alt: "Portrait studio noir et blanc — Rimiscky Sambala" },
  { src: "/photos/photo-23.jpg", width: 1800, height: 1350, alt: "Photographie par Rimiscky Sambala — série 21" },
  { src: "/photos/photo-22.jpg", width: 1200, height: 1800, alt: "Portrait extérieur — Rimiscky Sambala" },
  { src: "/photos/photo-19.jpg", width: 1800, height: 1800, alt: "Shooting créatif peinture — Rimiscky Sambala" },
  { src: "/photos/photo-25.jpg", width: 1013, height: 1800, alt: "Photographie par Rimiscky Sambala — série 24" },
  { src: "/photos/photo-24.jpg", width: 1529, height: 1800, alt: "Photographie par Rimiscky Sambala — série 25" },
  { src: "/photos/photo-26.jpg", width: 1200, height: 1800, alt: "Shooting éditorial — Rimiscky Sambala" },
  { src: "/photos/photo-27.jpg", width: 1800, height: 1800, alt: "Portrait cinématique dans la foule — Rimiscky Sambala" },
];
